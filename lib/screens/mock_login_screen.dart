  ...
  Future<void> _verifyCode() async {
    ...
    try {
      ...
      if (result != null) {
        ...
        _showError('Invalid verification code (try: 123456)');
      }
    } catch (e) {
            ...
            child: Column(
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'This is a demonstration of the authentication UI. All logins work instantly without real authentication.',
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.orange,
                      ),
              ...
              if (!_showCodeInput) ...[
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(_isLoading ? 'Sending...' : 'Sign in with Phone (Demo)'),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Verification Code (try: 123456)',
                    hintText: '123456',
              ...
              if (!_showCodeInput) ...[
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Continue with Apple (Demo)'),
                  style: ElevatedButton.styleFrom(
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Continue with Google (Demo)'),
                  style: ElevatedButton.styleFrom(
